...
- Your Stock Tracker is standard `.json` displayed which will need to be replaced with Apn info
- ApnToken Claim interactor works in making new claim and looking up a claim, buttons dont do exactly what they say they do but thats for later... it works for now. 
- Events...are events

still no ownership built into chain so that functionality is on the back burner
